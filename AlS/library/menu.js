...
function addMenuItem(label, action, color, mouseover, mouseout, myform) {
    this.items[this.items.length] = label;
    this.actions[this.actions.length] = action;
    this.myforms[this.myforms.length] = myform;
...
function addMenuSeparator() {
    ...
    this.myforms[this.myforms.length] = "";
...
//        setTimeout('delayWriteMenus()', 3000);
        setTimeout('delayWriteMenus()', 9000);
        return;
    }
...
//            var dText   = '<DIV ID="menuItemText'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColor +';">'+ item +'</DIV>\n<DIV ID="menuItemHilite'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColorHilite +';visibility:hidden;">'+ item +'</DIV>';
			var dText   = '<DIV ID="menuItemText'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColor +';">' + item +'</DIV>\n<DIV ID="menuItemHilite'+ countItems +'" STYLE="position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColorHilite +';visibility:hidden;">'+ '<a class="short" href="javascript:onMenuItemAction(null,this);">' + item +'</a></DIV>';
            if (item == "separator") {
    ...
    if (container.innerHTML) {
        ...
        container.document.writeln("<html>");
        container.document.writeln("<head>");
        container.document.writeln("<style type='text/css'>");
        container.document.writeln("a.short:active { font-family:  Arial, Helvetica, sans-serif; font-size: 12; color: #ffffff; text-decoration:  none} ");
		container.document.writeln("a.short:link { font-family: Arial, Helvetica, sans-serif; font-size: 12; color: #ffffff; text-decoration: none}");
		container.document.writeln("a.short:visited { font-family: Arial, Helvetica, sans-serif; font-size: 12; color: #ffffff; text-decoration: none} ");
		container.document.writeln("a.short:hover { font-family: Arial, Helvetica, sans-serif; font-size: 12; color:#ffffff; text-decoration: none; background-repeat: repeat}");
		container.document.writeln("</style>")		
		container.document.writeln("</head>")
		container.document.writeln("<body>");
    ...
    if (container.document.layers) {
        ...
        for (var i=0; i<container.document.layers.length; i++) {
            ...
            for (var n=0; n<body.document.layers.length-1; n++) {
                ...
                l.myform = container.menus[i].myforms[n];
        ...
        for (var x=0; x<container.menus.length; x++) {
            ...
            for (var i=0; i<container.menus[x].items.length; i++) {
                ...
                l.myform = container.menus[x].myforms[i];
...
/*    if (l.action) 
    {
        eval("" + l.action);
		document.frmtms.action = eval("" + l.action);
		document.frmtms.submit();
    }*/
    
    eval("top.window.document." + l.myform + ".action = '" + l.action + "';")
	eval("top.window.document." + l.myform + ".target = '_self'" + ";")
	eval("top.window.document." + l.myform + ".submit()" + ";")
}
