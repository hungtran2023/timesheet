					...
					if not rsIndividualRule.EOF then
						...
						if not rsIndividualRule.Eof then
						    ...
						    if rsIndividualRule("ExpiredDay") <>0 AND rsIndividualRule("ExpiredMonth")<>0 then
								...
								if intYear=year(Date()) then expiredDateThisYear=expiredDate
		    				end if
...
'Response.Write dblApplicationThisMonth& "--" & dblBalance
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td valign="top" class="text-right">
                                            ...
                                            <a href="<%=strHTTP%>aisnet" class="btn-custom">Holidays Booking</a>
