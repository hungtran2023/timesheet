		...
		<tr bgcolor="#FFFFFF" >
  	      ...
  	      <table width="80%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td class="blue">To</td>
                <td valign="top" class="blue-normal"><input type="text" name="txtTo" id="txtTo" size="10" class="blue-normal" language="javascript" onClick="document.frmreport.rdotype[0].checked=true" <%If strType="D" Then%>value="<%=ddmmyyyy(strTo)%>"<%End If%>></td>
                <td >&nbsp;</td>
              </tr>
              <tr bgcolor="#FFFFFF">                
