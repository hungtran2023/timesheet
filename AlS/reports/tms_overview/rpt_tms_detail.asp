...
'--------------------------------------------------
	...
	strFunction = "<a class='c' href='javascript:back_menu()' onMouseOver='self.status=&quot;;Return to main menu page&quot;;return true' onMouseOut='self.status=&quot;&quot;;return true'>Main Menu</a>&nbsp;&nbsp;&nbsp;<img height='5' src='../../images/dot.gif' width='5'>&nbsp;&nbsp;&nbsp;" & _
				  "<a class='c' href='javascript:goback()' onMouseOver='self.status=&quot;&quot;;return true'>Back</a>&nbsp;&nbsp;&nbsp;<img height='5' src='../../images/dot.gif' width='5'>&nbsp;&nbsp;&nbsp;" & _
...
function printpage()
{
	...
	objNewWindow = window.open('rpt_detail_print.asp?m=' + '<%=intMonth%>' + '&y=' + '<%=intYear%>' + '&title=' + '<%=strTitle1%>', "MyNewWindow", strFeatures);
...
function selstaff()
{
	...
	{
		objStaffWindow = window.open('rpt_select_staff.asp?view=d', "MyNewWindow", strFeatures);
	}
	window.status = "Opened a new browser window.";  
}
...
{
	if (ns)
		document.location = "rpt_staff_tms.asp";
	else
	{
		window.document.frmtms.action = "rpt_staff_tms.asp";
		window.document.frmtms.target = "_self";
		window.document.frmtms.submit();
	}	
}
  ...
  <tr> 
    <td bgcolor="#FFFFFF" valign="top"> 
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF" class="blue-normal" align="right" colspan="4"><%=strTitle1%>&nbsp;</td>
        </tr>  
      </table>
