...
<%
	...
	Dim intLeaveDuePast, intAppPast, dateExipred, intWorkHours
'--------------------------------------------------
...
'--------------------------------------------------
	...
	strFunction = "<a class='c' href='javascript:back_menu()' onMouseOver='self.status=&quot;Return to main menu page&quot;;return true' onMouseOut='self.status=&quot;&quot;;return true'>Main Menu</a>&nbsp;&nbsp;&nbsp;<img height='5' src='../../images/dot.gif' width='5'>&nbsp;&nbsp;&nbsp;" & _
				  "<a class='c' href='javascript:window.history.back();' onMouseOver='self.status=&quot;&quot;;return true'>Back</a>&nbsp;&nbsp;&nbsp;<img height='5' src='../../images/dot.gif' width='5'>&nbsp;&nbsp;&nbsp;" & _
...
function selstaff()
{
	...
	{
		objNewWindow = window.open('rpt_select_staff.asp?view=l', "MyNewWindow", strFeatures);
	}
		...
		<tr> 
		  <td valign="top"> 
			<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center" bordercolor="#003399">
			  ...
			  <tr> 
           			<td bgcolor="#FFFFFF" class="blue"> &nbsp;</td>
			  </tr>	
					<%end if
			  end if%>
			  <tr> 
