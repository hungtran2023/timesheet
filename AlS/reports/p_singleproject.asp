...
%>
			<tr bgcolor="#FFFFFF">
				<td valign='top' class='blue-normal'>&nbsp;<%=showlabel(arrSrc(0, i))%></td>
				<td valign='top' class='blue-normal'>&nbsp;<%=showlabel(arrSrc(1, i))%></td>
				<td valign='top' class='blue-normal'>&nbsp;<%=showlabel(arrSrc(2, i))%></td>
				<td valign='top' class='blue-normal'>&nbsp;<%=showlabel(strTaskname)%></td>
				<td valign='top' class='blue-normal' align='right'><%=FormatNumber(arrSrc(4, i), 2)%></td>
				<td valign='top' class='blue-normal' align='right'><%=FormatNumber(arrSrc(5, i), 2)%></td>
				<td valign='top' class='blue-normal' align='right'><%=FormatNumber(arrSrc(6, i), 2)%></td>
<%
		else
			strsavetask = ""%>
			<tr bgcolor="#FFF2F2">
<%			if arrSrc(7, i) = 1 then%>			
				<td valign='top' colspan='4' width='74%' class='blue' align='right'><%=arrSrc(3, i)%></td>
				<td valign='top' width='9%' class='blue' align='right'><%=FormatNumber(arrSrc(4, i), 2)%></td>
				<td valign='top' width='8%' class='blue' align='right'><%=arrSrc(5, i)%></td>
				<td valign='top' width='9%' class='blue' align='right'><%=FormatNumber(arrSrc(6, i), 2)%></td>
<%			else%>
				<td valign='top' colspan='6' width='91%' class='blue' align='right'><%=arrSrc(3, i)%></td>
				<td valign='top' width='9%' class='blue' align='right'><%=arrSrc(6, i)%></td>
