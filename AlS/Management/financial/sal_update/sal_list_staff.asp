	...
	If Not rsSrc.EOF Then
		For i = 1 To psize
			...
			strOut = strOut & "<tr bgcolor=" & strColor & ">" &_
			         "<td valign='top' width='33%' class='blue'><a href='javascript:viewsal(" & rsSrc("StaffID") & ");' " &_
			         "class='c' OnMouseOver = 'self.status=&quot;View or Update Salary&quot; ; return true' OnMouseOut =" &_
...
function viewsal(varid)
{
	...
	window.document.frmreport.action = "sal_detail_staff.asp";
...
%>					
			    ...
			    <tr align="center"> 
				  <td class="title" height="50" align="center" colspan="5">Update Salary</td>
			    </tr>
			  </table>
		    </td>
		  </tr>
		              ...
		              <tr> 
		                <td bgcolor="#617DC0"> 
		                  <table width="100%" border="0" cellspacing="1" cellpadding="5">
		                    <tr bgcolor="#8CA0D1"> 
		                      <td class="blue" align="center" width="188"><a href="javascript:sort('n')" onMouseOver="self.status='Sort by Full Name';return true" onMouseOut="self.status='';return true" class="c">Full Name</a></td>
		                  ...
		                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		                    <tr> 
		                      <td bgcolor="#FFFFFF" height="20" class="blue-normal" width="76%">&nbsp;&nbsp;* Click 
		                        on the exact name to view or update salary.</td>
