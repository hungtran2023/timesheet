...
function sort(kind)
{
	document.frmreport.action = "sal_select_staff.asp?act=vps" + kind;
...
function viewpage(kind)
{
	...
	if (kind == 1)
	{
		...
		{
			document.frmreport.action = "sal_select_staff.asp?act=vpa" + kind;
			document.frmreport.submit();
		}	
	}
	else
...
function search(kind)
{
	if (kind == "1")
	{
		...
		{
			document.frmreport.action = "sal_select_staff.asp?act=vra" + kind;
			document.frmreport.submit();	
		}
	}	
	else
...
{
	//opener.document.frmtms.action = "sal_type_staff.asp?act=vmya";
	opener.document.frmtms.action = "sal_staff_tms.asp?act=vmya";
