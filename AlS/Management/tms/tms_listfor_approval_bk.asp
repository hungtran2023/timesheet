...
function sort(kind)
{
	document.frmreport.action = "tms_listfor_approval.asp?act=vps" + kind;
...
function viewpage(kind)
{
	...
	if (kind == 1)
	{
		...
		{
			document.frmreport.action = "tms_listfor_approval.asp?act=vpa" + kind;
			document.frmreport.submit();
		}	
	}
	else
...
{
	if ((document.frmreport.txtname.value == "") && (document.frmreport.lbdepartment.options[document.frmreport.lbdepartment.selectedIndex].value == "0")&& (document.frmreport.lbApproval.options[document.frmreport.lbApproval.selectedIndex].value == "0"))
	{
		kind=2;
	}
	
	//alert(kind);
	document.frmreport.action = "tms_listfor_approval.asp?act=vra" + kind;
	document.frmreport.submit();	
}
...
function viewtms(varid)
{
	...
	window.document.frmreport.action = "tms_approval.asp";
		    ...
		    <td> 
		      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		        <tr <%If strError="" Then%> bgcolor="#FFFFFF" <%Else%> bgcolor="#E7EBF5" <%End If%>>
				  <td class="red" colspan="6" height="20" align="left" width="100%"> &nbsp;&nbsp;<b><%=strError%></b></td>
		        </tr>
		        <tr align="center"> 
		          <td class="blue-normal" height="30" align="right" width="15%">&nbsp;&nbsp;Name&nbsp;</td>
				  ...
				  <td class="blue" height="30" align="left" width="20%"> 
				    <select id="lbdepartment" size="1" name="lbdepartment" class="blue-normal" style="width:95%">
...
<%			Next
		End If%>    </select>
				  ...
				  <td class="blue" height="30" align="left"  width="10%"> 
				    <select id="lbApproval" size="1" name="lbApproval" class="blue-normal" style="width:95%">
					  <option value="0" <%=IIF(intApproval=0,"selected","")%>>&nbsp;</option>                    
					  <option value="1" <%=IIF(intApproval=1,"selected","")%>>Approved</option>
					  <option value="2" <%=IIF(intApproval=2,"selected","")%>>Pending</option>
				    </select>
				  </td>
			    ...
			    <tr align="center"> 
				  <td class="title" height="30" align="center" colspan="6">Approval register</td>
			    </tr>
			    <tr align="center"> 
				  <td class="blue-normal" height="50" align="center" colspan="6">From <b>Mon, <%=day(dateFrom) & "/" & month(dateFrom) & "/" & year(dateFrom)%></b> to <b>Sun,<%=day(dateTo) & "/" & month(dateTo) & "/" & year(dateTo)%></b></td>
			    </tr>
			  </table>
		    </td>
		  </tr>
		              ...
		              <tr> 
		                <td bgcolor="#617DC0"> 
		                  <table width="100%" border="0" cellspacing="1" cellpadding="5">
		                    <tr bgcolor="#8CA0D1"> 
		                      <td class="blue" align="center" width="30%"><a href="javascript:sort('n')" onMouseOver="self.status='Sort by Full Name';return true" onMouseOut="self.status='';return true" class="c">Full Name</a></td>
		                      <td class="blue" align="center" width="25%"><a href="javascript:sort('t')" onMouseOver="self.status='Sort by Job Title';return true" onMouseOut="self.status='';return true" class="c">Job Title</a> </td>
		                      <td class="blue" align="center" width="30%"><a href="javascript:sort('r')" onMouseOver="self.status='Sort by leader';return true" onMouseOut="self.status='';return true" class="c">Reports to</a> </td>
		                      <td class="blue" align="center" width="15%">Approved</td>
		                    </tr>
<%
...
%>                            
		                  ...
		                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		                    <tr> 
		                      <td bgcolor="#FFFFFF" height="20" class="blue-normal" width="76%">&nbsp;&nbsp;* Click a name to view timesheet.</td>
		                      <td bgcolor="#FFFFFF" height="20" class="blue" width="24%" align="right">&nbsp;</td>
		                    </tr>
		                    <tr> 
		                      <td bgcolor="#FFFFFF" height="20" class="blue-normal" colspan="2">&nbsp;&nbsp;* Click a column header to sort the list based on that column </td>
		                    </tr>
		                    <tr> 
                  ...
                  <td align="right" bgcolor="#E7EBF5"> 
                    <table width="70%" border="0" cellspacing="1" cellpadding="0" height="20">
                      <tr class="black-normal"> 
						...
						<td valign="middle" align="right" width="28%" class="blue-normal">
							<%If CInt(intCurPage) <> 1 Then%><a href="javascript:viewpage(2);" onMouseOver="self.status='Move Previous';return true" onMouseOut="self.status='';return true">Previous</a><%End If%>
							<%If CInt(intCurPage) <> 1 And  CInt(intCurPage) <> CInt(intTotalPage) Then%>/<%End If%>
							<%If CInt(intCurPage) <> CInt(intTotalPage) And (CInt(intTotalPage) <> 0 Or intTotalPage <> "") Then%><a href="javascript:viewpage(3);" onMouseOver="self.status='Move Next';return true" onMouseOut="self.status='';return true"> Next</a><%End If%>&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                    </table>
                  </td>
                </tr>
