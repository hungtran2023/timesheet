...
'--------------------------------------------------
	...
	If Request.QueryString("act") = "vmya" Then
...
'--------------------------------------------------
	...
	strFunction = "<a class='c' href='javascript:back_menu()' onMouseOver='self.status=&quot;Return to main menu page&quot;;return true' onMouseOut='self.status=&quot;&quot;;return true'>Main Menu</a>&nbsp;&nbsp;&nbsp;<img height='5' src='../../images/dot.gif' width='5'>&nbsp;&nbsp;&nbsp;" & _
				  ...
				  "<a class='c' href='javascript:selstaff();' onMouseOver='self.status=&quot;Select employee to view timesheet detail&quot;;return true' onMouseOut='self.status=&quot;&quot;;return true'>Select Employee</a>&nbsp;&nbsp;&nbsp;<img height='5' src='../../images/dot.gif' width='5'>&nbsp;&nbsp;&nbsp;" & _
	...
	varFullName = split(objEmployee.GetFullName,";")
	strTitle1	= "Timesheet detail of <b>" & varFullName(0) & " - " & varFullName(1) & "</b>"
...
function printpage()
{
	...
	{
		objNewWindow = window.open('tms_detail_print.asp?m=' + '<%=intMonth%>' + '&y=' + '<%=intYear%>' + '&title=' + '<%=strTitle1%>', "MyNewWindow", strFeatures);
	}
...
function selstaff()
{
	...
	{
		objNewWindow = window.open('tms_select_staff.asp?view=d', "MyNewWindow", strFeatures);
	}
	window.status = "Opened a new browser window.";  
}
...
function viewleave()
{
	...
	{
		//window.document.frmtms.action = "tms_view_leave.asp";
  ...
  <tr> 
    <td bgcolor="#FFFFFF" valign="top"> 
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td bgcolor="#FFFFFF" class="blue-normal" align="right" colspan="4" height="20"><%=strTitle1%>&nbsp;</td>
        </tr>  
      </table>
...
<!--<table width="780" border="0" cellspacing="0" cellpadding="0" height="20" align="center">  <tr>     <td align="right" bgcolor="#E7EBF5">       <table width="70%" border="0" cellspacing="1" cellpadding="0" height="20">        <tr class="black-normal">           <td align="right" valign="middle" width="37%" class="blue-normal">Page</td>          <td align="center" valign="middle" width="13%" class="blue-normal">             <input type="text" name="txtpage" class="blue-normal" value="1" size="2" style="width:50">          </td>          <td align="left" valign="middle" width="7%" class="blue-normal">&nbsp;<a href="tms_viewdetails.asp#"><font color="#990000">Go</font></a></td>          <td align="right" valign="middle" width="15%" class="blue-normal">Pages 1/10&nbsp;&nbsp;</td>          <td valign="middle" align="right" width="28%" class="blue-normal"><a href="tms_viewdetails.asp#">Previous Page</a> /<a href="tms_viewdetails.asp#"> Next</a>&nbsp;&nbsp;&nbsp;</td>        </tr>      </table>    </td>  </tr></table>-->
<%
'--------------------------------------------------
