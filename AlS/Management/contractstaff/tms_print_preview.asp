...
'--------------------------------------------------
	...
	strTPUserid=Request.QueryString("s")
...
'--------------------------------------------------
	...
	strSQL="SELECT TPUserID, UserName, Department, Fullname FROM HR_TPStaff WHERE TPUserID=" & strTPUserid
	
	Call GetRecordset(strSQL ,rsData)	

	
	strTitle1	= "Timesheet " & intMonth & "/" & intYear & " of " & rsData("Fullname")
'Response.Write 	strTitle1
'--------------------------------------------------
' Read template page from file
'--------------------------------------------------

Call ReadFromTemplate(strTitle1, strFunction, arrPageTemplate, "../tms/templates/template1/")
%>	
