...
'			Response.Write strError		
	...
	Else
		...
		For ii = 1 To Request.Form("chkget").Count
			...
			test= tmsAddsubtaskforTP(strPID, strPName, intParentID, strSubTask, intAssignmentID, intMonth, intYear)
...
<!--
    ...
    window.opener.document.frmtms.txtUserid.value = "<%=intStaffID%>";
    window.opener.document.frmtms.action = "timesheetTP.asp?act=ast";
    window.opener.document.frmtms.submit();
