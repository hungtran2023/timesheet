...
function Outbody(ByRef rsSrc)
	...
	while not rsSrc.EOF
		...
		strOut = strOut & "<tr bgcolor='" & strColor & "'>" &_
				...
				"<td valign='top' class='blue'><input type='checkbox' name='chkass' value='" & rsSrc("AtlasParticipantID") & "'" & " " & strCHK & "></td>" &_
				"</tr>"
...
'--------------------------------------------------
	intAtlasCourseID=Request.QueryString("id")
	if intAtlasCourseID="" then intAtlasCourseID=Request.Form("txtAtlasCourseID")
	
'--------------------------------------------------
' Get data from ATC_AnnualLeaveDefaultRule
'--------------------------------------------------

strSQL="SELECT * FROM [ATC_AtlasCourses] WHERE AtlasCourseID=" & intAtlasCourseID
...
if gMessage="" then 
	if rsData.RecordCount>0 then		
		strCourseTitle=rsData("CourseName")
		strCode=rsData("AtlasCourseCode")
		strDuration="From: " & rsData("StartDate") & " To:" & rsData("EndDate")
		strInstruction=rsData("Instructor")
	end if
	rsData.close
end if
...
if strAct="de" then
	...
	if countU<>"" then
		...
		if ret then
				strDelete="DELETE FROM ATC_AtlasCourseParticipant WHERE AtlasParticipantID IN (" & countU & ")"
				if not objDb.runActionQuery(strDelete) then gMessage = objDb.strMessage

			if gMessage<>"" then 
				response.write 		"<BR>" & gMessage
			end if
			objDb.dbdisConnect
		else
...
strSQL="SELECT a.*, b.Fullname, b.Jobtitle FROM ATC_AtlasCourseParticipant a INNER JOIN HR_Employee b ON b.PersonID=a.StaffID WHERE AtlasCourseID=" & intAtlasCourseID & " ORDER BY Fullname"
...
function DeAssign()
{
	...
	document.frmwh.action = "ListOfAttendeesCourse.asp?act=de";
	document.frmwh.target = "_self";
	document.frmwh.submit();
}
            ...
            <td> 
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="middle">
                  ...
                  <td  height="50" align="center" class="title">Detail of <span class="blue"><%=strCourseTitle%></span></td>
                </tr>
        
                <tr> 
                  <td bgcolor="#FFFFFF" valign="top">
					<table width="30%" border="0" align="center" cellpadding="1" cellspacing="0" bgcolor="#003399">
                      <tr> 
                            ...
                            <tr> 
                              <td bgcolor="#C0CAE6"  >                              
								<table width="100%" border="0" cellspacing="5" cellpadding="5">
									<tr>                                     
										<td valign="middle" align="center" class="blue"> <%=strCode%> </td>
									</tr>
									<tr>                                    
										<td valign="middle" align="center" class="blue-normal"> <%=strDuration%></td>
									</tr>
                                    <tr> 
										<td valign="middle" align="center" class="blue-normal"> By &nbsp; <%=strInstruction%></td>
									</tr>
                                </table>
                              </td>
                            </tr>
                        ...
                        <td bgcolor="#617DC0"> 
                          <table width="100%" border="0" cellspacing="1" cellpadding="4">
                            <tr bgcolor="8CA0D1"> 
                              ...
                              <td class="blue" align="center" width="45%">Full Name</td>
                              <td class="blue" align="center" width="45%">Job Title</td>
