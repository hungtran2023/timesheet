					...
					<table class="table table-hover" id="tblList">
						<thead  class="thead-inverse tableheaderblue">						
							<tr class="filters" style="background-color:#8ca0d1">								
								<th><input type="text" class="form-control blue-normal" placeholder="APK" disabled></th>
								<th><input type="text" class="form-control blue-normal" placeholder="ProjectName" disabled></th>
								<th><input type="text" class="form-control blue-normal" placeholder="Manager" disabled></th>
								<th><input type="text" class="form-control blue-normal" placeholder="Status" disabled></th>
								<th><input type="text" class="form-control blue-normal" placeholder="Server" disabled></th>
