	...
	If Not rsSrc.EOF Then
		For i = intStart To intFinish
			...
			strOut = strOut & "<tr bgcolor=" & strColor & " status='" & rsSrc("fgStatus")&"'>" &_
			         "<td valign='top' class='blue-normal'>" & Showlabel(rsSrc("ProjectKey")) & "</td>" &_
			         "<td valign='top' class='blue-normal'>" & Showlabel(rsSrc("ProjectName")) & "</td>" &_
					 "<td valign='top' class='blue-normal'>" & day(rsSrc("DateTransfer")) & "/" & month(rsSrc("DateTransfer")) & "/" & Year(rsSrc("DateTransfer")) & "</td>" &_
					 "<td valign='top' class='blue-normal'>" & Showlabel(rsSrc("Department")) & "</td>" &_
					 "<td valign='top' class='blue-normal'>" & Showlabel(rsSrc("BDM")) & "</td>" &_
					  "<td valign='top' class='blue-normal' idValue="& rsSrc("ManagerID") &">" & Showlabel(rsSrc("Manager")) & "</td>" &_
...
<%If strError <> "" Then%>  
	...
	<div class="row">
        <div class="col-sm-6 col-sm-offset-3">
			...
			<form name="searchform" method="post" action="n_projectlist.asp">
				<div class="form-group">
					<div class="input-group stylish-input-group">
						<input type="text" name="txtSearch" id="txtSearch" onkeyup="myFunction()" class="form-control"  placeholder="Search by APK or Project Name" >
...
$( document ).ready(function() { 
	...
	$("#tblList tbody tr").click(function(e) {
...
function showPage(intpage){
	window.location = "n_projectlist.asp?navi=" + intpage;
}
