	...
	if not rsSrc.EOF then
		For i = 1 to psize
			...
			strOut = strOut & "<tr bgcolor=" & strColor & ">" &_
			         "<td valign='top' width='15%' class='blue'><a href='javascript:goRelativepage(" & chr(34) & rsSrc("ProjectID") &_
			         chr(34) & ", " & chr(34) & strpname & chr(34) & ", 1);' class='c' OnMouseOver = 'self.status=&quot;Project Informations&quot; ; return true;' OnMouseOut =" &_
			         " 'self.status = &quot;&quot;'>" & Showlabel(rsSrc("ProjectID")) & "</a></td>" &_
			         ...
			         "<td valign='top' width='10%' class='blue-normal' align='center'><a href='javascript:goRelativepage(" & chr(34) &_
			         rsSrc("ProjectID") & chr(34) & ", " & chr(34) & strpname & chr(34) & ", 3);' OnMouseOver = 'self.status=&quot;Projects Assignment&quot; ; return true;' " &_
			         "OnMouseOut = 'self.status = &quot;&quot;'>...</a></td>" &_
			         "<td valign='top' width='17%' class='blue-normal' align='center'><input name='chkActive' type='checkbox' value='" & rsSrc("ProjectID") & "' " & strAct & "></td>" &_
			         "</tr>" & chr(13)
			rsSrc.MoveNext
...
function OutHeader(Byval sortType, ByVal Col)
    ...
    strOut=strOut & "<td class='blue' bgcolor='8CA0D1' width='15%'>&nbsp;<a href='javascript:sort(&quot;ProjectID&quot;," & strTypeForID & ");' class='c' onMouseOver='self.status=&quot;Order by ProjectID&quot; ; return true;' onMouseOut='self.status=&quot;&quot;'>APK</a></td>" & chr(13)
    strOut=strOut & "<td class='blue' width='45%'>&nbsp;<a href='javascript:sort(&quot;ProjectName&quot;," & strTypeForName & ");' class='c' onMouseOver='self.status=&quot;Order by ProjectID&quot; ; return true;' onMouseOut='self.status=&quot;&quot;'>Project Name</a></td>" & chr(13)
    strOut=strOut & "<td class='blue' align='center' width='13%'>Assignment</td>" & chr(13)
    strOut=strOut & "<td class='blue' align='center' width='10%'>Right</td>" & chr(13)
    strOut=strOut & "<td class='blue' align='center' width='17%'>Activated</td></tr>" & chr(13)
...
var numpage = <%=session("NumPage")%>;
	if (curpage < numpage) {
		...
		document.navi.action = "listofproject.asp?page=" + (curpage + 1)
...
function go() {
	...
	if ((intpage > 0) && (intpage <= numpage) && (intpage != curpage)) {
		document.navi.action = "listofproject.asp?page=" + intpage
		document.navi.target = "_self";
		document.navi.submit();		
	}
}
...
function sort(column,type) {
	document.navi.action = "listofproject.asp?page=1&sorttype=" + type + "&Col=" + column; //1: id, 2: name, 3: activate
	document.navi.target = "_self";
	document.navi.submit();
}
...
function activeproject(type) {
	...
	if (strID!="") {
		...
		document.navi.action = "listofproject.asp?active=" + type;
		document.navi.target = "_self";
		document.navi.submit();
	}
	else
...
function search() {
	...
	document.navi.action = "listofproject.asp?search=" + tmp;
	document.navi.target = "_self";
	document.navi.submit();	
}
...
function goRelativepage(varid, varname, varkind) {
	...
	if(varkind==1)
		varfilename = "subtask.asp";
	else if(varkind==2)
		varfilename = "assignment.asp";
	else
		varfilename = "assignright.asp";
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                ...
                <tr> 
                  ...
                  <td align="left" width="15%" valign="middle" > 
                    <select name="lbActived" class='blue-normal'style="width:95%">
                      <option value="1" <%if cint(varActive)=1 then %>selected<%end if%>>Activated</option>
                      <option value="0"<%if cint(varActive)=0 then %>selected<%end if%>>Deactivated</option>
                    </select>
                  </td>                  
                  <td class="blue" align="left" width="20%" valign="middle" > 
                ...
                <tr> 
                  <td class="title" height="50" align="center" colspan="5">List of Projects</td>
                </tr>
              </table>
            </td>
          </tr>
