...
function Outbody(ByRef rsSrc)
	...
	while not rsSrc.EOF
		...
		strOut = strOut & "<tr bgcolor='" & strColor & "'>" &_
				...
				"<td valign='top' class='blue'><input type='checkbox' name='chkass' value='" & rsSrc("StaffExpiredRuleID") & "'" & " " & strCHK & "></td>" &_
				"</tr>"
...
strSQL="SELECT KeepPassYear,ExpiredDay,ExpiredMonth,Rulenote,fgActivate FROM ATC_AnnualLeaveYearlyRule WHERE RuleYearlyID=" & intRuleID
...
if strAct="de" then
	...
	if countU>0 then
		...
		if ret then
			...
			if strDelete<>"" then 
				strDelete="DELETE FROM ATC_EmployeeExpiredRule WHERE StaffExpiredRuleID IN (" & Left(strDelete,len(strDelete)-1) & ")"
...
strSQL="SELECT a.*, b.Fullname, b.Jobtitle FROM ATC_EmployeeExpiredRule a " & _
			"INNER JOIN HR_Employee b ON b.PersonID=a.StaffID WHERE RuleYearlyID=" & intRuleID
...
function Assign()
{	
	document.frmwh.action = "selectemployee_assExpiredRule.asp?outside=1";
...
function DeAssign()
{	
	document.frmwh.action = "DetailOfExpiredRule.asp?act=de";
	document.frmwh.target = "_self";
	document.frmwh.submit();
}
          ...
          <tr> 
            <td> 
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="middle">
                  <td class="title" height="50" align="center">Detail of Expired Rule</td>
                </tr>
                            ...
                            <tr> 
                              <td bgcolor="#C0CAE6" >                              
								<table width="100%" border="0" cellspacing="5" cellpadding="0">                               
                                  <tr>
									<td valign="middle" class="blue-normal">&nbsp;&nbsp;Expired Date:</td>
									<td valign="middle" class="blue-normal"> <%=intDay & "-" & arrlongmon(intMonth-1)%>                               </td>                                    
                                  </tr>                                   
								  <tr> 
                                    <td valign="middle" class="blue-normal">&nbsp;&nbsp;Keep Pass year </td>
                                    <td valign="middle" class="blue"><%=dblKeepPassYear%> </td>
                                  </tr>                                                            
                                  <tr> 
                                    <td valign="middle" class="blue-normal">&nbsp;&nbsp;</td>
                                    <td valign="middle" class="blue-normal"><%=showlabel(strNote)%></td>
                                  </tr>                                  
                                </table>
                              </td>
                            </tr>
