...
Function AddNewRule
	...
	If objDb.dbConnect(strConnect) then	
		...
		strSql="INSERT INTO ATC_AnnualLeaveDefaultRule (RatePerYear,RuleNote) " & _
				"VALUES(" & dblRate & ",'" & Replace(strNote,"'","''") & "')"
...
if strview="ALL" then
	strSQL="SELECT RuleID,RatePerYear,RuleNote,fgActivate FROM ATC_AnnualLeaveDefaultRule ORDER BY RuleID DESC"
else
	strSQL="SELECT RuleID,RatePerYear,RuleNote,fgActivate FROM ATC_AnnualLeaveDefaultRule WHERE fgActivate=1 ORDER BY RuleID DESC"
end if
